...
description: "Master context management to unlock HAI's full potential"
---

<Info>
**Quick Reference**

- **Context** = All information HAI knows about your project
- **Context Window** = Maximum information HAI can process at once (varies by model)
- **Token** = Unit of text measurement (~3/4 of an English word)
- **Auto-management** = HAI automatically handles context through Focus Chain & Auto Compact
</Info>

## What is Context Management?

Context management is how HAI maintains understanding of your project throughout a conversation. Think of it as the shared memory between you and HAI - containing code, decisions, requirements, and progress.

<Frame caption="Context is like a shared workspace where HAI builds understanding of your project">
	<img
...
## How HAI Builds Context

Building effective context is what makes HAI truly useful. When you start a task, HAI doesn't just passively wait for information - he actively gathers context about your project, asks clarifying questions when needed, and adapts to what's happening in real-time. This combination of automatic discovery, user guidance, and dynamic adaptation ensures HAI always has the right information to solve your problems effectively.

### 1. Automatic Context Gathering

When you start a task, HAI proactively:
...
**What HAI automatically discovers:**
...
While automatic discovery handles much of the work, you control what HAI focuses on. The more specific and relevant context you provide, the better HAI can understand your needs and deliver accurate solutions.
...
- **Answering questions** when HAI needs clarification

### 3. Dynamic Context Adaptation

HAI adapts context dynamically throughout your conversation. It considers the complexity of your request, available context window space, current task progress, error messages and feedback, plus previous decisions made during the conversation to determine what information matters most at each step.
...
HAI includes intelligent systems that handle context for you:

### Focus Chain (Default: ON)

Focus Chain maintains task continuity through automatic todo lists. When you start a task, HAI generates actionable steps and updates them as work progresses. This keeps critical context visible even after Auto Compact runs, letting you track progress without scrolling through the entire conversation.
...
If your conversation approaches the model's context window limit before Auto Compact runs, HAI's Context Manager automatically truncates older parts of the conversation to prevent errors.
...
This happens automatically. You'll keep working without interruption, and HAI maintains enough context to continue solving your problem effectively.

## Best Practices

- **Be specific** - Clear objectives help HAI understand your needs
...
<CardGroup cols={2}>
	...
	<Card title="HAI Rules" icon="gavel" href="/features/cline-rules">
