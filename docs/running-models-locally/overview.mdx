...
## Running Models Locally with HAI

Run HAI completely offline with genuinely capable models on your own hardware. No API costs, no data leaving your machine, no internet dependency.

Local models have reached a turning point where they're now practical for real development work. This guide covers everything you need to know about running HAI with local models.
...
| 64GB | Qwen3 Coder 30B | 8-bit | Full HAI features |
...
After extensive testing, **Qwen3 Coder 30B** is the most reliable model under 70B parameters for HAI:
...
- **Proven reliability** - Consistent outputs with HAI's tool format
...
Most models under 30B parameters (7B-20B) fail with HAI because they:
...
- Switch to bash in HAI Settings → Terminal → Default Terminal Profile
...
## Community & Support
- **GitHub**: [Report issues](https://github.com/presidio-oss/hai-build-codegen)
...
Local models with HAI are now genuinely practical. While they won't match top-tier cloud APIs in speed, they offer complete privacy, zero costs, and offline capability. With proper configuration and the right hardware, Qwen3 Coder 30B can handle most coding tasks effectively.
