---
title: "Groq"
description: "Learn how to configure and use Groq's lightning-fast inference with HAI. Access models from OpenAI, Meta, DeepSeek, and more on Groq's purpose-built LPU architecture."
---
...
3.  **Create a Key:** Navigate to the API Keys section and create a new API key. Give your key a descriptive name (e.g., "HAI").
4.  **Copy the Key:** Copy the API key immediately. You will not be able to see it again. Store it securely.

### Supported Models

HAI supports the following Groq models:
