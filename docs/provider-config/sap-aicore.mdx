...
- **Service Plan Requirement:** You must have the SAP AI Core `extended` service plan to use LLMs with HAI. Other service plans do not provide access to Generative AI Hub.
