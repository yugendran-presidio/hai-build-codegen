---
title: "Baseten"
description: "Learn how to configure and use Baseten's Model APIs with HAI. Access frontier open-source models with enterprise-grade performance, reliability, and competitive pricing."
---
...
**IMPORTANT: For Kimi K2 Thinking:** To use the `moonshotai/Kimi-K2-Thinking` model, you must enable **Native Tool Call (Experimental)** in HAI settings. This setting allows HAI to call tools through their native tool processor and is required for this reasoning model to function properly.

### Supported Models

HAI supports all current models under Baseten Model APIs, including:
...
-   **Dynamic Model Updates:** HAI automatically fetches the latest model list from Baseten, ensuring access to new models as they're released in real time.
