...
3. **Create a Key:** Click "Create API key" and give your key a descriptive name (e.g., "HAI").
4. **Copy the Key:** **Important:** Copy the API key _immediately_. You will not be able to see it again. Store it securely.

### Supported Models

HAI supports the following Fireworks AI models:
